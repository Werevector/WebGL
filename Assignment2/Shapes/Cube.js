...
function Cube(x,y,z)
{
  ...
  this.points =
  [                                   //              Index
    vec4(0,       0,       0, 0.5),        //point A Origin  | 0
    vec4(XVector, 0,       0, 0.5),        //point B         | 1
    vec4(XVector, 0, ZVector, 0.5),        //point C         | 2
    vec4(0,       0, ZVector, 0.5),        //point D         | 3

    vec4(0,       YVector,       0, 0.5),  //point E         | 4
    vec4(XVector, YVector,       0, 0.5),  //point F         | 5
    vec4(XVector, YVector, ZVector, 0.5),  //point G         | 6
    vec4(0,       YVector, ZVector, 0.5)   //point H         | 7
  ];
